...
module.exports = {
  async up(queryInterface) {
    ...
    // 2. Rename remaining 6 categories and set images (served from /uploads on the API server)
    const updates = [
      { slug: 'agricultural-land', nameEn: 'Lands', nameTe: 'భూములు', image: '/uploads/categories/lands.jpg' },
      { slug: 'apartment', nameEn: 'Apartments', nameTe: 'అపార్ట్\u200Cమెంట్లు', image: '/uploads/categories/apartments.jpg' },
      { slug: 'open-plot', nameEn: 'Approved Layouts', nameTe: 'ఆమోదించబడిన లేఅవుట్లు', image: '/uploads/categories/approved-layouts.jpg' },
      { slug: 'farm-land', nameEn: 'Farm Lands', nameTe: 'ఫార్మ్ ల్యాండ్స్', image: '/uploads/categories/farm-lands.jpg' },
      { slug: 'villa', nameEn: 'Villa Projects', nameTe: 'విల్లా ప్రాజెక్టులు', image: '/uploads/categories/villa-projects.jpg' },
      { slug: 'independent-house', nameEn: 'Individual Houses', nameTe: 'ఇండివిడ్యుయల్ హౌస్\u200Cలు', image: '/uploads/categories/independent-house.jpg' },
    ];
