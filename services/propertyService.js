...
/** Empty/whitespace/"null"/"undefined" strings collapse to '' so UI never shows junk. */
...
class PropertyService {
  ...
  format(property, req) {
    ...
    return {
      ...
      titleTe: cleanText(property.titleTe),
      descriptionEn: cleanText(property.descriptionEn),
      descriptionTe: cleanText(property.descriptionTe),
      ventureName: cleanText(property.ventureName),
      transactionType: property.transactionType || 'sale',
      state: cleanText(property.state),
      district: cleanText(property.district),
      mandal: cleanText(property.mandal),
      city: cleanText(property.city),
      locality: cleanText(property.locality),
      landmark: cleanText(property.landmark),
      pincode: cleanText(property.pincode),
      address: cleanText(property.address),
      locationEn: cleanText(property.locationEn),
      locationTe: cleanText(property.locationTe),
      mapLocation: cleanText(property.mapLocation),
      ...
      area: cleanText(property.area) || null,
      areaUnit: property.areaUnit || 'sqft',
      dimensions: cleanText(property.dimensions),
      facing: cleanText(property.facing),
      northMeasurement: cleanText(property.northMeasurement),
      eastMeasurement: cleanText(property.eastMeasurement),
      westMeasurement: cleanText(property.westMeasurement),
      southMeasurement: cleanText(property.southMeasurement),
      detailsJson: details,
      ...
      contactName: cleanText(property.contactName),
      contactPhone: cleanText(property.contactPhone),
